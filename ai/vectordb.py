...
# Uploading Vectors
def upload_vectors(
    index: pinecone.Index, message_embeddings: List[Dict[str, Any]]
) -> None:
...
# Querying the Index
def query_index(
    index: pinecone.Index, query_vector: List[float], top_k: int = 5
) -> Dict[str, List[Dict[str, Union[str, float, List[float]]]]]:
